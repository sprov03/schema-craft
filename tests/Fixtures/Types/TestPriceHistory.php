...
use SchemaCraft\Primitives\Collection;

/**
 * Typed collection fixture for the SDK golden test.
 *
 * Extends SchemaCraft\Primitives\Collection — class identity carries the cast, schema
...
class TestPriceHistory extends Collection
{
}
